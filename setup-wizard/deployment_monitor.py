        ...
        try:
            ...
            while self.is_running:
                ...
                if project_prefix:
                    ...
                    deployment_status['logs'].append(f"Detected project prefix: {project_prefix} with {len(ca_manager_containers)} containers")
                else:
                    deployment_status['logs'].append("Could not detect project prefix, no containers found")
